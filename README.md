...
| **GUI** | Planned | Orchestration only — **no analytical logic in GUI** |
...
```
tcr-sf-pb/
├── src/tcr_bcr_tools/     # Core library and analysis modules
├── tests/                 # pytest suite
...
### Phase 0.5.x — Project mode

- [ ] `project.yaml` configuration
- [ ] Reproducible project directory layout (`raw/`, `intermediate/`, `outputs/`, `figures/`, `logs/`, `cache/`)
- [ ] Single-command pipeline runner

### Phase 0.6.x — Adapters

- [ ] 10x adapter (formalize current extraction)
- [ ] BD Rhapsody adapter
- [ ] AIRR adapter
